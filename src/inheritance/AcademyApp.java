...
//학원 인적자원(학원, 강사, 직원) 관리 프로그램 
public class AcademyApp {
	public static void main(String[] args) {
		/*
		//학생정보를 저장하기 위한 여러 개의 요소들이 존재하는 배열 선언 
		...
		//직원정보를 저장하기 위한 여러 개의 요소들이 존재하는 배열 선언 
		AcademyStaff[] staffs=new AcademyStaff[100];
		 */
		
		//학원 인적자원 정보(학생, 강사, 직원)을 저장하기 위한 요소들이 존재하는 배열
		...
		for(AcademyPerson person:persons) {
			...
			//=> 참조변수에 저장된 부모 인스턴스와 상속 관계로 설정된 자식 인스턴스의 클래스인 경우
			//	 true를 제공하고 아닌 경우 false 제공 
			...
			//=> 메소드 오버라이드에 의한 다형성 - 자식 인스턴스에 따라 메소드가 선택되어 호출됨  
			person.display();
			System.out.println("======================================================");
		}
	}
