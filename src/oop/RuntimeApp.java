...
public class RuntimeApp {
	public static void main(String[] args) {
		...
		//Runtime.freeMemory() : JVM이 사용할 수 있는 남은 메모리 크기를 반환하는 메소드  
		System.out.println("청소 전 사용 메모리 크기 = "+(Runtime.getRuntime().totalMemory()
		...
		System.out.println("청소 후 사용 메모리 크기 = "+(Runtime.getRuntime().totalMemory()
				-Runtime.getRuntime().freeMemory())+"Byte");
		System.out.println("===========================================");
