...
public class MethodApp {
	...
	public static void main(String[] args) {
		//String[] args : 파라먼트, 아규먼츠, void : 반환형  //연속적인 문자열 데이터가 들어가는 저장공간
		
		//객체(인스턴스:Instance)를 생성하여 참조변수에 저장 
		// 인스턴스 생성 방법 : 
		//형식) 클래스명 참조변수=new 클래스명();***
		// + 내 정리 : 객체정보 저장 위해 참조변수 생성 = 생성자를 호출해 객체 생성   
		...
		//입력(input) 및 출력(output) 명령은 App 프로그램에서 작성 - 메소드에서는 작성하지 않는다 => 재사용성 떨어지기 때문  
