...
public class TwoArrayApp {
	public static void main(String[] args) {
		int[][] num=new int[2][3]; //[행의 갯수][열의 갯수]; 요소첨자 2개 
		...
		System.out.println("=====================================================");
		//int[][] su=new int[][] {{10,20,30},{40,50,60},{70,80,90}}; //중괄호 안 중괄호 바깥은 2차원, 안쪽은 1차원 
		int[][] su={{10,20,30},{40,50,60},{70,80,90}};
		//for문 2개, 2차원별이 갖고 있는 요소의 갯수와 1차원별이 갖고 있는 요소의 갯수 
